        ...
        <ToastContext.Provider value={{ showToast }}>
            ...
            <div className="fixed bottom-6 left-6 z-[100] flex flex-col gap-3 pointer-events-none">
                {toasts.map((toast) => (
                    <div
                        key={toast.id}
                        className={`flex items-center gap-3 px-5 py-4 rounded-lg shadow-2xl transform transition-all duration-300 animate-in slide-in-from-left-full pointer-events-auto border-r-4 ${
